...
:mod:`codex_rosetta.capabilities` for finer control over individual stages.
...
def apply_ir_transforms(
    ...
    *,
    ...
    Builds a :class:`~codex_rosetta.shims.transforms.TransformContext` from
    the provided parameters and runs the shim's ``ir_transforms`` tuple
    through :func:`~codex_rosetta.shims.transforms.apply_ir_transforms`.
...
class StreamProcessor:
    ...
    :class:`~codex_rosetta.converters.base.context.StreamContext` state
    across calls.
