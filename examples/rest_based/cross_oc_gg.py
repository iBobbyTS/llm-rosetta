#!/usr/bin/env python3
"""Cross-provider multi-turn conversation: OpenAI Chat <-> Google GenAI (REST).
...
Usage:
    ...
    proxychains -q python examples/rest_based/cross_oc_gg_rest.py

    # Or if both are directly accessible
    python examples/rest_based/cross_oc_gg_rest.py
...
def main():
    """Run cross-provider multi-turn conversation between OpenAI Chat and Google GenAI via REST."""
    print("=" * 60)
