...
Usage:
    ...
    proxychains -q python examples/rest_based/cross_an_or_stream.py

    # Or if both providers are directly accessible
    python examples/rest_based/cross_an_or_stream.py
...
def main():
    """Run cross-provider multi-turn streaming conversation between Anthropic and OpenAI Responses via REST."""
    print("=" * 60)
