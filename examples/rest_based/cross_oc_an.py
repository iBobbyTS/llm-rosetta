#!/usr/bin/env python3
"""Cross-provider multi-turn conversation: OpenAI Chat <-> Anthropic (REST).
...
Usage:
    ...
    proxychains -q python examples/rest_based/cross_oc_an_rest.py
...
def main():
    """Run cross-provider multi-turn conversation between OpenAI Chat and Anthropic via REST."""
    print("=" * 60)
