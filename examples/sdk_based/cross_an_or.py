#!/usr/bin/env python3
"""Cross-provider multi-turn conversation: Anthropic <-> OpenAI Responses (SDK).

Demonstrates Codex-Rosetta's ability to maintain conversation context across
different LLM providers using SDK clients. Odd turns use Anthropic,
...
Usage:
    ...
    python examples/sdk_based/cross_an_or.py
...
def main():
    """Run cross-provider multi-turn conversation between Anthropic and OpenAI Responses."""
    print("=" * 60)
