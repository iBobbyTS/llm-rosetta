#!/usr/bin/env python3
"""Cross-provider multi-turn conversation: Google GenAI <-> OpenAI Responses (SDK, Stream).
...
Usage:
    ...
    proxychains -q python examples/sdk_based/cross_gg_or_stream.py

    # Or if both are directly accessible
    python examples/sdk_based/cross_gg_or_stream.py
...
def main():
    """Run cross-provider multi-turn streaming conversation between Google GenAI and OpenAI Responses."""
    print("=" * 60)
