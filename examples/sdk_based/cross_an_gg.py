#!/usr/bin/env python3
"""Cross-provider multi-turn conversation: Anthropic <-> Google GenAI (SDK).
...
Usage:
    ...
    python examples/sdk_based/cross_an_gg.py
...
def main():
    """Run cross-provider multi-turn conversation between Anthropic and Google GenAI."""
    print("=" * 60)
