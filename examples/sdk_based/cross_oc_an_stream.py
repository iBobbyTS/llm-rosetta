...
Usage:
    ...
    proxychains -q python examples/sdk_based/cross_oc_an_stream.py
...
def main():
    """Run cross-provider multi-turn streaming conversation between OpenAI Chat and Anthropic."""
    print("=" * 60)
    ...
    providers = [
        ...
        ("Anthropic", lambda msgs: send_anthropic_stream(msgs, an_model, an_client)),
    ]
