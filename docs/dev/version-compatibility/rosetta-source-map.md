...
| Routing, Provider identity, and HTTP/SSE transport | `src/codex_rosetta/routing.py`, `src/codex_rosetta/gateway/proxy.py`, `providers.py`, `transport/provider_info.py`, `transport/http/`, `transport/sse_format.py` | `tests/gateway/test_downstream_routes.py`, `test_responses_passthrough.py`, `test_http_transport_limits.py`, `test_stream_telemetry_lifecycle.py`, `tests/integration/gpt_relay/` | `CP-01`, `CP-02`, `CP-03`, `CP-17`, `CP-21`, `CP-22` |
...
| Search, page opening, browser sidecar, and Images | `src/codex_rosetta/gateway/codex_search.py`, `codex_search_references.py`, `codex_page.py`, `codex_images.py`, `web_search.py`, `web_run_capabilities.py`, `web_run_health.py`, `web_run_sidecar.py`, `web_run_supervisor.py`, `resources/web_run/`, `image_workers.py`, `codex_auxiliary.py`, `admin/routes/config.py`, `admin/routes/_shared.py` | `tests/gateway/test_codex_search.py`, `test_codex_page.py`, `test_codex_auxiliary.py`, `test_web_search_bridge.py`, `test_web_run_health.py`, `test_web_run_sidecar.py`, `test_web_run_supervisor.py`, `test_web_run_google_search.py`, `test_web_run_bing_search.py`, `test_downstream_routes.py`, `test_admin_config_routes.py`, `tests/live_agent/network_search/`, `tests/live_agent/browser_use/`, `tests/live_agent/image_generation/` | `CP-03`, `CP-09`, `CP-15`, `CP-16`, `CP-22` |
| Model catalog, task models, and local-mode Provider | `src/codex_rosetta/gateway/codex_models.json`, `codex_models_version.md`, `codex_models_0_144_4.json`, `codex_model_presets.json`, `model_presets.py`, `local_mode.py`, `cli.py`, `config.py`, `providers.py`, `admin/routes/config.py` | `tests/gateway/test_model_presets.py`, `test_local_mode.py`, `test_cli_local_mode.py`, `test_config.py`, `test_admin_config_routes.py` | `CP-07`, `CP-14`, `CP-21`, `CP-22`, `CP-23` |
